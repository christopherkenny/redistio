...
These features allow for analyzing more complex maps, with live comparisons with simulations.
For example, with the following code, you can have many more options:
